      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav mx-auto">
            <!--ATTENTION A LA CLASS ACTIVE -->
            <li class="nav-item <?= $view === 'index' ? 'active' : '' ?> px-lg-4">
              <a class="nav-link text-uppercase text-expanded" href="./">Home
                <span class="sr-only">(current)</span>
              </a>
            </li>
            <li class="nav-item <?= $view === 'about' ? 'active' : '' ?> px-lg-4">
              <a class="nav-link text-uppercase text-expanded" href="./about">About</a>
            </li>
            <li class="nav-item <?= $view === 'products' ? 'active' : '' ?> px-lg-4">
              <a class="nav-link text-uppercase text-expanded" href="./products">Products</a>
            </li>
            <li class="nav-item <?= $view === 'store' ? 'active' : '' ?>  px-lg-4">
